...
![banner of @ttsc/evidence](https://ttsc.dev/og.jpg)
...
Evidence Graph was developed as an independent package while its rule model and adoption path matured. It now lives in the `ttsc` repository as `@ttsc/evidence`, the first-party rule contributor to `@ttsc/lint`.
