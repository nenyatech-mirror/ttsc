...
export const COMMONJS_PLUGIN_DESCRIPTOR_SHIM_SOURCE = [
  ...
  `            const retryWithTtsx = candidate !== undefined && [".ts", ".cts", ".mts", ".tsx"].some((extension) => fs.existsSync(candidate + extension) || fs.existsSync(path.join(candidate, "index" + extension)));`,
