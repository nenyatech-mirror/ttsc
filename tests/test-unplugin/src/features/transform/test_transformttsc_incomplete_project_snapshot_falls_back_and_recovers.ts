 ...
 *
 * A graph-bearing generation normally uses narrow persistent validation. If
 * one subtree could not be enumerated, that shortcut would omit its files and
 * could replay stale output forever after the filesystem recovered.
 *
