 ...
 * Vite serve or worker cache must not reread that union before every module.
 * It still has to reject relevant edits and project-membership changes.
 *
 ...
 *    edit replaces it.
 * 3. Add a new ambient project file and assert directory membership replaces
 *    the generation too.
 */
